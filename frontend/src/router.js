...
const routes = [
  { path: '/', name: 'CarrierList', component: () => import('./views/CarrierList.vue'), meta: { title: '承运商列表 - 延长物流信用评价系统（Demo）' } },
  { path: '/profile/:id', name: 'CreditProfile', component: () => import('./views/CreditProfile.vue'), meta: { title: '信用画像 - 延长物流信用评价系统（Demo）' } },
